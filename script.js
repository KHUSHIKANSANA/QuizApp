const questions = [
 ...
 const startButtonEle = document.querySelector(".start-btn")
 const welcomeScreenEle = document.querySelector(".welcome-screen")
 const quizScreenEle = document.querySelector(".quiz-screen")
 const questionEl = document.querySelector(".question");
 const answersButtons = document.querySelector(".answer-container")
 const nextButtonEl = document.querySelector(".next-btn")


 startButtonEle.addEventListener("click", startQuiz);

 function startQuiz() {
    welcomeScreenEle.style.display = "none";
    quizScreenEle.style.display = "flex";
    currentQuestionIndex = 0;
    userScore = 0;
    nextButtonEl.innerHTML = 'Next';
    nextButtonEl.style.display='none';
    displayQuestion();  //doubt yha pr function bnaya hai 
}
...
function displayQuestion() {
    ...
    //answrs show krne k liye function
    questions[currentQuestionIndex].answers.forEach((answer)=> {
        ...
        // console.log(buttonEl); for checking data is add or not
